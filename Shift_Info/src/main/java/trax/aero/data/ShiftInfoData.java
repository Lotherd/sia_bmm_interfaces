...
public class ShiftInfoData {
    ...
    public List<ShiftInfo> getShiftPatternsData() {
     ...
     // Fixed SQL query string for the getShiftPatternsData() method in Java
     // All SQL comments removed to prevent ORA-00936 error
     ...
     String selectSql =
         ...
         "     AND dsp.DAY_WORK_HOURS IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.DAY_START_HOUR, 2, '0') || ':' || LPAD(dsp.DAY_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.DAY_WORK_HOURS, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         "  END AS ENDTIME, " +
         ...
         "     AND dsp.BREAK_01 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_01_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_01_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_01, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         ...
         "     AND dsp.BREAK_02 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_02_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_02_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_02, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         ...
         "     AND dsp.BREAK_03 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_03_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_03_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_03, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         ...
         "     AND dsp.BREAK_04 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_04_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_04_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_04, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         ...
         "     AND dsp.BREAK_05 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_05_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_05_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_05, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
         ...
         "     AND dsp.BREAK_06 IS NOT NULL THEN " +
         "      TO_CHAR( " +
         "        TO_DATE(LPAD(dsp.BREAK_06_START_HOUR, 2, '0') || ':' || LPAD(dsp.BREAK_06_START_MINUTE, 2, '0'), 'HH24:MI') " +
         "        + NUMTODSINTERVAL(dsp.BREAK_06, 'HOUR'), " +
         "        'HH24:MI' " +
         "      ) " +
         "    ELSE NULL " +
